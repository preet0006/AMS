...
const MainForm = () => {
  ...
  return (
      ...
      <form onSubmit={handleFormClick}  className="w-full mt-6 space-y-6">
        ...
        <div className="flex  flex-wrap gap-4 px-6">
          ...
          {fields.map((field, idx) => (
            <label
              key={idx}
              className={`${field.full ? "basis-full " : "flex-1 min-w-[300px] lg:min-w-[470px] px-1 relative "}`}
            >
            {field.optional && (
   ...
   <div className="flex flex-wrap  gap-4 px-6">
    ...
    <div className="flex flex-col mt-8 space-y-1 h-fit text-gray-400">
    <h3 className="text-2xl text-white "> Consent and Privacy</h3>

    <div className="flex flex-col pl-3 space-y-1">
       <span className="mt-2 "> <input type="checkbox" name="" id="" /> i consent to recive treatment for my health condition </span>
        <span className=""> <input type="checkbox" name="" id="" /> i consent to use and disclosure of my health information for treatment purposes  </span>
            <span className=""> <input type="checkbox" name="" id="" /> i acknowledge that i have reviewed and agree to the privacy policy </span>
     ...
     <button type="submit" className="bg-blue-800 mt-5 mb-10 w-full py-3 text-[18px] rounded-xl">
